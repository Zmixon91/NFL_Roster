...
function Player(name, position, playerNumber) {
    ...
    this.card = '<div class="playerCard" id="' + id + '"><input type="button" class="btn btn-danger" value="Remove"><div><img src="http://s.nflcdn.com/static/content/public/image/fantasy/transparent/200x200/" alt=""><p>' + name + '</p><p>' + position + '</p><p>' + playerNumber + '</p></div></div>';
};
